...
class IntakePredictor():
    ...
    def predict_top5_foods(user_id):
        ...
        filename = os.path.join(IntakePredictor.folder, user_id + '_intake_predictor.pkl')
        label_encoder_filename = os.path.join(IntakePredictor.folder, user_id + '_label_encoder.joblib')
